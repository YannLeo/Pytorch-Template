# @.@ coding  : utf-8 ^_^
# @Author     : Leon Rein
# @Time       : 22/11/21 ~ 11:18:16
# @File       : make_mnist_m.py
# @Note       : copy from internet, need keras
...
if __name__ == '__main__':
    ...
    """
    # 初始化路径
    BST_PATH = os.path.abspath('mnist-m/BSR_bsds500.tgz')
    mnist_dir = os.path.abspath("./")
    mnistm_dir = os.path.abspath("./")
    ...
    train_files = [name for name in f.getnames() if name.startswith('BSR/BSDS500/data/images/train/')]
