# @.@ coding  : utf-8 ^_^
# @Author     : Leon Rein
# @Time       : 22/12/04 ~ 15:36:54
# @File       : resnet1D.py
# @Note       : copied and modified a little from https://github.com/hsd1503/resnet1d/blob/master/resnet1d.py
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, stride, groups, downsample, use_bn,
                 use_do, is_first_block=False):
...
class ResNet1D(nn.Module):
    ...
    def __init__(self, in_channels, base_filters, kernel_size, stride, groups, n_block, n_classes,
                 downsample_gap=2, increasefilter_gap=4, use_bn=True, use_do=False, verbose=False):
